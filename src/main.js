...
function init() {
  ...
  sections.forEach((section, i) => {
    ...
    const model = section.getAttribute("data-three-section");
  ...
  if (scenesLoaded) {
    scenes.forEach(function (scene) {
      ...
      if (scene.userData.animationEnded) {
        cameraGroup.rotation.y += (-cursor.x - cameraGroup.rotation.y) * 0.1;
        cameraGroup.rotation.x += (-cursor.y - cameraGroup.rotation.x) * 0.1;
      }
